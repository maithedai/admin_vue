      ...
      <div class="auth-inner">
        ...
        <div @submit.prevent="handleLogin">
          ...
          <div class="form-group">
            ...
            <input type="email" ref="email" class="form-control" v-model="email" placeholder="Địa chỉ Email"
              @input="$v.email.$touch" @blur="$v.email.$touch()" :state="$v.email.$dirty ? !$v.email.$error : null" />
          ...
          <div class="form-group">
            ...
            <small class="text-danger" v-if="$v.password.$error">
              ...
              <span v-if="!$v.password.minLength">Mật khẩu phải có ít nhất {{$v.password.$params.minLength.min}}
                kí tự!</span>
              <span v-if="!$v.password.maxLength">Mật khẩu có nhiều nhất {{$v.password.$params.maxLength.max}} kí
                tự!</span>
            </small>
          </div>
